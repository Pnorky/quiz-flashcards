...
class FlashcardPage extends qx.ui.container.Composite {
    constructor() {
        ...
        this.__seenCardIndexes = new Set();
        this.__correctedCardIndexes = new Set();
        ...
        const studyControls = new qx.ui.container.Composite(new qx.ui.layout.HBox(8).set({ alignY: "middle" }));
        ...
        const modeRow = new qx.ui.container.Composite(new qx.ui.layout.HBox(8).set({ alignY: "middle" }));
        ...
        const editorActionRow = new qx.ui.container.Composite(new qx.ui.layout.HBox(8).set({ alignY: "middle" }));
    ...
    __saveEditorCard() {
        var _a, _b, _c, _d;
        const question = (_b = (_a = this.__editorQuestionInput.getValue()) === null || _a === void 0 ? void 0 : _a.trim()) !== null && _b !== void 0 ? _b : "";
        const answer = (_d = (_c = this.__editorAnswerInput.getValue()) === null || _c === void 0 ? void 0 : _c.trim()) !== null && _d !== void 0 ? _d : "";
        if (!question || !answer) {
    ...
    __renderState() {
        ...
        this.__statsLabel.setValue(`Viewed: ${this.__seenCardIndexes.size} | Flips: ${this.__sessionFlips} | Corrected: ${this.__correctedCardIndexes.size}`);
    }
}
